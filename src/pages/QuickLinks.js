...
const QuickLinks = () => {
    return (
        <div className='m-5 md:flex '>
            <div className='md:w-2/4 md:h-auto w-full flex md:flex-row flex-col md:m-5 p-2 md:p-6 md:relative'>
                <img src='https://via.placeholder.com/400' alt='schoolimg' className='rounded w-full md:h-80 h-80 md:w-2/4 md:absolute md:left-4 left-0 top-0 ' />
                <div className='rounded md:bottom-20 md:absolute md:right-0 bg-blue-950/100 md:bottom-0  md:w-2/4'>
